       ...
       <div class="row">
         <div class="col-md-8" align="center">
            <div class="media-area">
               <div class="media">
                  <a class="pull-left" href="#paper-kit"></a>
                     <div class="media-body">
                        <hr data-brackets-id="12673">
                        <ul data-brackets-id="12674" id="sortable" class="list-unstyled ui-sortable">
                         </br>
                  <?php
                     foreach ($value['comments'] as $com) { ?>
                  ...
                  ?>
                        ...
                        <div class="media media-post">
                           <form class="blog-form" action="../lib/send_comment.php" method="POST">
                              <input name="user_name" value="<?php if($_SESSION['logged']){ echo $_SESSION['username']; } else { echo "Guest"; }?>" hidden>
